...
export interface IDbCarouselDeal {
  id?: number;
  type?: DealType | null;
  title?: string | null;
...
export class DbCarouselDeal implements IDbCarouselDeal {
  constructor(
    public id?: number,
...
export function getDbCarouselDealIdentifier(dbCarouselDeal: IDbCarouselDeal): number | undefined {
  return dbCarouselDeal.id;
}
