...
export interface ISideDisplayDeal {
  id?: number;
  type?: DealType | null;
  title?: string | null;
...
export class SideDisplayDeal implements ISideDisplayDeal {
  constructor(
    public id?: number,
...
export function getSideDisplayDealIdentifier(sideDisplayDeal: ISideDisplayDeal): number | undefined {
  return sideDisplayDeal.id;
}
