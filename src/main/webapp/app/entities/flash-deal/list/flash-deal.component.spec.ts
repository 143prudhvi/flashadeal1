...
describe('FlashDeal Management Component', () => {
  let comp: FlashDealComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(FlashDealComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.flashDeals?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
