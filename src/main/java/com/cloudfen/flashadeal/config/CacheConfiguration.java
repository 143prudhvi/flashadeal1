...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.cloudfen.flashadeal.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.cloudfen.flashadeal.repository.UserRepository.USERS_BY_EMAIL_CACHE);
