...
/**
 * Criteria class for the {@link com.cloudfen.flashadeal.domain.FlashDeal} entity. This class is used
 * in {@link com.cloudfen.flashadeal.web.rest.FlashDealResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /flash-deals?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class FlashDealCriteria implements Serializable, Criteria {
    ...
    public FlashDealCriteria() {}

    public FlashDealCriteria(FlashDealCriteria other) {
    ...
    @Override
    public FlashDealCriteria copy() {
        return new FlashDealCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FlashDealCriteria that = (FlashDealCriteria) o;
        return (
