...
/**
 * Criteria class for the {@link com.cloudfen.flashadeal.domain.DbCarouselDeal} entity. This class is used
 * in {@link com.cloudfen.flashadeal.web.rest.DbCarouselDealResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /db-carousel-deals?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class DbCarouselDealCriteria implements Serializable, Criteria {
    ...
    public DbCarouselDealCriteria() {}

    public DbCarouselDealCriteria(DbCarouselDealCriteria other) {
    ...
    @Override
    public DbCarouselDealCriteria copy() {
        return new DbCarouselDealCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final DbCarouselDealCriteria that = (DbCarouselDealCriteria) o;
        return (
