...
export class FlashDealComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-flash-deal div table .btn-danger'));
  title = element.all(by.css('jhi-flash-deal div h2#page-heading span')).first();
...
export class FlashDealUpdatePage {
  pageTitle = element(by.id('jhi-flash-deal-heading'));
...
export class FlashDealDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-flashDeal-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-flashDeal'));
