...
export class SideDisplayDealComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-side-display-deal div table .btn-danger'));
  title = element.all(by.css('jhi-side-display-deal div h2#page-heading span')).first();
...
export class SideDisplayDealUpdatePage {
  pageTitle = element(by.id('jhi-side-display-deal-heading'));
...
export class SideDisplayDealDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-sideDisplayDeal-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-sideDisplayDeal'));
